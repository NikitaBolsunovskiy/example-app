...
@Entity
@Table(name = "customs_order_invoice_address")
@Audited(withModifiedFlag = true)
data class CustomsOrderInvoiceAddress(
    ...
    @JoinColumn(name = "customs_order_invoice_id", nullable = false)
    var customsOrderInvoice: CustomsOrderInvoice? = null,
    ...
    override fun retrieveCustomsOrderId(): Long? = customsOrderInvoice?.customsOrder?.id

    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is CustomsOrderInvoiceAddress) return false
